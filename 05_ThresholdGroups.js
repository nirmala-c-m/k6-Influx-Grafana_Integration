...
export const options = {
   ...
   thresholds: {
      ...
      'group_duration{group:::Login}': ['max>=0'],
      'group_duration{group:::PostPayload}': ['max>=0'],
      'group_duration{group:::GetUserDetails}': ['max>=0'],
   },
   summaryTimeUnit: 's',
};
